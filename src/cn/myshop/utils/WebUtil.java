...
import cn.myshop.bean.BuyCart;
import cn.myshop.bean.privilege.Employee;
...
public class WebUtil {
    ...
    /***
     * 获取URI的路径,如路径为http://localhost:8080/action/post.htm?method=add, 得到的值为"/action/post.htm"
     * @param request
     * @return
     */
