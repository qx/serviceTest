...
<SCRIPT language=JavaScript src="/js/xmlhttp.js"></SCRIPT>
  ...
  <!--
	...
	function checkUsername(){
		...
		send_request(
		function(value){viewobj.innerHTML=value},
//"http://localhost:8080/user/reg_isUserExist?username="+username,
"/user/reg_isUserExist?username="+username,
		//'<html:rewrite action="/user/reg_isUserExist"/>?username='+username,
		true
		);
	}
  //-->
...
<div id="Content">
<form action="/user/reg_reg.action" method="post" onsubmit="javascript:return checkForm()">
