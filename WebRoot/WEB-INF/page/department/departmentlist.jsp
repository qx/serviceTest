...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <famous:permission module="department" privilege="update">
      ...
      <td bgcolor="f5f5f5"> <div align="center">
        <famous:permission module="department" privilege="delete">
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <famous:permission module="department" privilege="insert">
